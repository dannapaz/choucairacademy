...
public class ChoucairLoginPage extends PageObject {
    ...
    public static final Target INPUT_USER= Target.the("where do we write to user")
            .located(By.id("username"));
    public static final Target INPUT_PASSWORD= Target.the("where do we write to password")
